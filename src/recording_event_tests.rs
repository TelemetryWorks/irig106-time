...
fn event_type_started() {
    assert_eq!(
        RecordingEventType::from_index(0x01),
...
fn event_type_stopped() {
    assert_eq!(
        RecordingEventType::from_index(0x02),
...
fn event_type_overrun() {
    assert_eq!(
        RecordingEventType::from_index(0x03),
        RecordingEventType::Overrun
    );
}
...
fn event_type_index_point() {
    assert_eq!(
        RecordingEventType::from_index(0x04),
        RecordingEventType::IndexPoint(0x04)
    );
    assert_eq!(
        RecordingEventType::from_index(0x0F),
        RecordingEventType::IndexPoint(0x0F)
    );
}
...
fn event_type_reserved() {
    assert_eq!(
        RecordingEventType::from_index(0x10),
        RecordingEventType::Reserved(0x10)
    );
    assert_eq!(
        RecordingEventType::from_index(0xFF),
        RecordingEventType::Reserved(0xFF)
    );
}
...
fn event_type_display() {
    assert_eq!(
        format!("{}", RecordingEventType::Started),
        "Recording Started"
    );
    assert_eq!(
        format!("{}", RecordingEventType::Overrun),
        "Recording Overrun"
    );
    assert_eq!(
        format!("{}", RecordingEventType::IndexPoint(5)),
        "Index Point 5"
    );
    assert_eq!(
        format!("{}", RecordingEventType::Reserved(0x20)),
        "Reserved(0x20)"
    );
}
